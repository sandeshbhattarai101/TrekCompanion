...
return(
    ...
    <div className='mainContactContainer h-[920px] w-screen bg-white'>
    <div className='mainContactHeading border-b border-opacity-25 border-black mb-15 pb-15 absolute top-[10%] left-[10%]'>
    <h2 className='ContactHeadingFirst mb-5'>Contact Us</h2>
    </div>
   ...
   <div className='subContactContainer flex flex-row absolute top-[20%] left-[10%]'>
    <div className='firstContactContainer'>
        ...
        <form onSubmit={submitMessage} className='flex flex-col absolute left-[5px] text-lg' action="/contactus" method='post'>
            ...
            <input className='mb-1 mt-2 w-96 h-10 rounded border-custom-gray border text-base' type="email" name='email' id='email' placeholder=' Enter your email address' required />
           ...
           <p>We want your input: questions, bug reports, complaints, praise, feature requests — every little bit helps.
             ...
             <input  type="submit" value="Send Message" className='sendMessage mb-1 mt-2 w-96 h-10 rounded border-custom-gray border text-base bg-red-600 text-white text-lg w-36'/>
