...
<nav className="navbar text-slate-100  flex top-0 w-screen h-[50px] bg-teal-600  z-10 sticky  shadow-md items-center  ">

 

<Link className="navbarLogo text-lg absolute left-24 " to="/">{props.title}</Link>
   <div className='navbarLeft  hidden   lg:flex absolute left-[250px] top-[10px] '>
